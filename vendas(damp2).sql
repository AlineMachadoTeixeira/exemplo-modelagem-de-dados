...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/08/2023 às 16:55
...
(1, 'Ultrabook', 'Equipamento de última geração cheio de recursos, com processador Inter Core i9 do balacobaco', 3500.00, 7, 2),
(2, 'Tablet Android', 'Tablet com versão 14 do sistema operacional Android, possui tela de 10 polegadas e armazenamento de 128 GB, e 64 GB de RAM.', 1500.99, 20, 2),
(3, 'Geladeira', 'Refrigerador frost-free com acesso à Internet.', 5000.00, 12, 6),
(4, 'iPhone 18 pro Max', 'Smartphone Apple cheio de frescuras e caro pra caramba.', 6549.74, 20, 3),
(5, 'iPad Mini', 'Tablet Apple com tela retina display e bla bla bla.', 4999.01, 20, 3),
(6, 'Xbox Serie S', 'Velocidade e desempenho de última geração.', 1997.00, 5, 8),
